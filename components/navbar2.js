        ...
        <div className="flex hidden md:block justify-between space-x-3">
          <div className="flex space-x-6 text-blue-900">
            <a
              ...
              href="https://www.facebook.com/movepiaui/"
              target="_blank"
              rel="noreferrer">
            ...
            <a
              className="hover:opacity-75"
              href="https://www.instagram.com/movepiaui/"
              target="_blank"
              rel="noreferrer">
            ...
            <a
              className="hover:opacity-75"
              href="https://www.youtube.com/channel/UCHm0zNqKSMyXzDYoZmXNejw"
              target="_blank"
              rel="noreferrer">
        ...
        <div className="container mx-auto max-w-6xl py-3 flex justify-between">
          ...
          {/* <div className="relative hidden max-w-lg sm:block">
            <input
              ...
              className="block w-full rounded-md border border-white bg-transparent px-4 py-2 text-gray-900 focus:border-primary-500 focus:ring-primary-500 dark:border-gray-900 dark:bg-gray-800 dark:text-white"
            />
            <svg
